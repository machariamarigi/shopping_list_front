...
/**
 * Component for the loader to be displayed when asyncronous actions are taking place
 */
class Loader extends Component {
  ...
  render() {
    const numberOfSegments = this.props.segments || 10;
    const dValue =
    ...
    return (
      <div className="flex-container loader">
        <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid" className="centeredContent svg">
          {segments || (
            // `ref` callback used to trigger off the animation
